...
def model_prediction(test_image):
    ...
    return result_index  # Return the result index
...
if app_mode == "Home":
    ...
    image_path = "tree.jpg"
    st.image("tree.jpg", use_container_width=True)
    st.markdown("""
    ...
    if test_image is not None and st.button("Predict"):
        ...
        if test_image is not None:
            try:
                ...
                result_index = model_prediction(test_image)  # Get the index of the predicted class
                
                # Class names (This should match the order in your training data)
                class_name = [
                ...
                # Check if result_index is valid and within the bounds
